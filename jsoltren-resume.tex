%	extitaTeX resume using res.cls
...
% \address used twice to have two	extitines of address
...
\item Member of elite team responsible for the proprietary NVIDIA graphics
      driver stack for	extitinux, FreeBSD, and Solaris.
\item Technical	extitead - Video Decode and Post-Processing API for UNIX (VDPAU).
...
\item Added support for next generation H.265/HEVC hardware video decode to
      the	extitinux driver and to VDPAU.
...
\item Responsible for video post processing shaders in Cg and GLSL	extitanguages.
...
\item {\sl Technologies used: C, C++, Python, Makefile; gcc, gdb,	extitinux kernel,
       NVIDIA GPUs, OpenGL, firmware/microcodes.}
\end{itemize}
 
\section{COMPUTER \\ SKILLS} {\sl	extitanguages \& Software:} COBOL, IFPS, Focus, 
         Megacalc, Pascal, Modula2, C, APL, SNOBOL, 
                FORTRAN,	extitISP, SPIRES, BASIC, VSPC Autotab, 
                IBM 370 Assembler,	extitotus 1-2-3. \\
...
\section{EXPERIENCE} {\sl Business Applications Programmer} \hfill Fall 1990 \\
                ...
                Financial Planning Department,	extitatham, NY
                 \begin{itemize}  \itemsep -2pt % reduce space between items
...
\section{EXTRA-CURRICULAR \\ ACTIVITIES}             
            ...
            Attended Krannet	extiteadership Conference \\
